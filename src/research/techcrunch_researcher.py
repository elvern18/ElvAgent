"""
TechCrunch researcher for fetching AI industry news.
Fetches from TechCrunch AI RSS feed and scores relevance.
"""
...
class TechCrunchResearcher(BaseResearcher):
    """Researcher for TechCrunch AI news."""

    RSS_URL = "https://techcrunch.com/category/artificial-intelligence/feed/"

    def __init__(self, max_items: int = 5):
        """Initialize TechCrunch researcher."""
        super().__init__(source_name="techcrunch", max_items=max_items)

    async def fetch_content(self) -> list[ContentItem]:
        """
        Fetch and parse TechCrunch RSS feed.
        ...
        try:
            ...
            for entry in feed.entries:
                try:
                    ...
                    # Skip if outside time window (use 24 hours for TechCrunch)
