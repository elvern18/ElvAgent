...
class DatabaseServer:
                ...
                Tool(
                    ...
                    inputSchema={
                        ...
                        "properties": {
                            "url": {
                                "type": "string",
                                "description": "Content URL to check"
                            },
                            "title": {
                                "type": "string",
                ...
                Tool(
                    ...
                    inputSchema={
                        ...
                        "properties": {
                            ...
                            "source": {"type": "string", "description": "Content source (arxiv, huggingface, etc.)"},
                            "category": {"type": "string", "description": "Content category (research, product, funding, news)"},
                            "newsletter_date": {"type": "string", "description": "Newsletter date (YYYY-MM-DD-HH)"},
    ...
    async def _store_content(self, item: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            # Generate content ID
            content_id = self.state_manager.generate_content_id(
                item["url"],
                item["title"]
            )
    ...
    async def _get_metrics(self, target_date: Optional[str] = None) -> Dict[str, Any]:
        """
